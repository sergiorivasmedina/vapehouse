...
var Breadcrumbs2 = function Breadcrumbs2(args) {
  ...
  var items = paths.map(function (path, i) {
    return _react2.default.createElement(Route, { key: i.toString(), path: path, component: BreadcrumbsItem2 });
  });
...
var AppBreadcrumb2 = function (_Component) {
  ...
  AppBreadcrumb2.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      Tag,
      { className: classes },
      _react2.default.createElement(Route, _extends({ path: '/:path', component: Breadcrumbs2 }, attributes))
    );
  };
...
exports.default = AppBreadcrumb2;
